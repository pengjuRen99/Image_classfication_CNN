...
from models.residual_block import make_basic_block_layer, make_bottlenck_layer
...
class ResNetTypeI(tf.keras.Model):
    def __init__(self, layer_params):
        ...
        self.fc = tf.keras.layers.Dense(units=NUM_CLASSES, activation=tf.keras.activation.softmax)
...
class ResNetTypeII(tf.keras.Model):
    def __init__(self, layer_params):
        ...
        self.layer1 = make_bottlenck_layer(filter_num=64, blocks=layer_params[0])
        self.layer2 = make_bottlenck_layer(filter_num=128, blocks=layer_params[1], stride=2)
        self.layer3 = make_bottlenck_layer(filter_num=256, blocks=layer_params[2], stride=2)
        self.layer4 = make_bottlenck_layer(filter_num=512, blocks=layer_params[3], stride=2)
