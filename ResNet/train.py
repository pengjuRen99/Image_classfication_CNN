...
if __name__ == '__main__':
    ...
    # 使用独热编码需要更改loss和accuracy的评判标准      CategoricalCrossentropy
    # 数字编码使用SparseCategoricalCrossentropy
    ...
    # 图像分类精度
    # Epoch: 600/600， train loss: 0.15714, train accuracy: 0.94627, valid loss: 0.96582, valid accuracy: 0.73623
