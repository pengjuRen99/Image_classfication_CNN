...
from models.inception_modules import InceptionModule_1, InceptionModule_2, InceptionModule_3, InceptionModule_4, InceptionModule_5, InceptionAux, Preprocess
...
class InceptionV3(tf.keras.Model):
    def __init__(self, num_class, aux_logits=True):
        ...
        self.avg_pool = tf.keras.layers.AvgPool2D(pool_size=(6, 6), strides=1, padding='VALID')
